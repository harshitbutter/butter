    ...
    <div className="min-h-screen bg-background font-sans overflow-x-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-600 mb-10 leading-relaxed">
                Finding the right talent for high-impact roles is not easy. We
                leverage our extensive network and deep industry expertise to
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <SectionHeader
            title="Our Approach"
            subtitle="A rigorous, data-backed methodology to find the perfect match."
            light
          />

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            <div className="relative p-8 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-sm">
              <div className="absolute -top-6 left-8 bg-primary text-black font-bold text-xl w-12 h-12 rounded-xl flex items-center justify-center shadow-lg transform rotate-3">
                1
              </div>
              <div className="mt-6">
                <h3 className="text-xl font-bold mb-4 flex items-center gap-2">
                  <FileSearch className="w-5 h-5 text-primary" /> Requirement
                  Understanding
                </h3>
                <p className="text-gray-400">
                  Our team of ex-consultants deeply analyzes your business
                  context, culture, and specific role needs to create a
            ...
            <div className="relative p-8 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-sm">
              <div className="absolute -top-6 left-8 bg-primary text-black font-bold text-xl w-12 h-12 rounded-xl flex items-center justify-center shadow-lg transform -rotate-2">
                2
              </div>
              <div className="mt-6">
                <h3 className="text-xl font-bold mb-4 flex items-center gap-2">
                ...
                <p className="text-gray-400">
                  We don't just rely on job portals. We tap into our proprietary
                  database of 50k+ premium talent and high-trust referrals.
                </p>
              </div>
            </div>

            <div className="relative p-8 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-sm">
              <div className="absolute -top-6 left-8 bg-primary text-black font-bold text-xl w-12 h-12 rounded-xl flex items-center justify-center shadow-lg transform rotate-1">
                3
              </div>
              <div className="mt-6">
                <h3 className="text-xl font-bold mb-4 flex items-center gap-2">
                  <UserCheck className="w-5 h-5 text-primary" /> Extensive
                  Screening
                </h3>
                <p className="text-gray-400">
                  Our rigorous screening framework includes detailed case
                  studies and transcript analysis to ensure only the top 1% make
                  it to you.
                </p>
              </div>
            </div>
            ...
            {[
              {
                ...
                role: "Co-Founder",
                description:
                  "IIM Calcutta '21 graduate with strategic expertise from Alvarez & Marsal and PwC. Harshit brings deep consulting rigor to talent acquisition.",
                linkedIn:
                  "https://www.linkedin.com/in/harshit-chandak-4751b3a1/",
              ...
              },
              {
                ...
                role: "Co-Founder",
                description:
                  "IIM Calcutta '21 graduate with 4+ years of product experience at Naukri. Ayush understands the tech talent landscape inside out.",
      ...
      <section id="contact" className="py-24 bg-zinc-900 relative">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <SectionHeader
            ...
            subtitle="Tell us about your hiring needs, and we'll get to work."
            light
          />
